...
![image-20231107085036502](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107085036502.png)

**我们需要在我们商户端的后台设置一个定时任务，例如5分钟后没有收到异步通知的结果，那我们商户平台就需要主动去查询用户订单**

查询支付订单的方式有两种：根据微信支付订单号查询和根据商户订单号查询

![image-20231107091816612](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107091816612.png)



其中微信支付订单号是在我们订单支付成功之后，微信平台向商户平台发送的通知中的transaction_id字段

![image-20231107092001453](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107092001453.png)
...
![image-20231107093224422](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107093224422.png)

![image-20231107093307080](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107093307080.png)
...
![image-20231107094436848](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107094436848.png)
...
> [springboot---任务---整合quartz与task----定时任务（详细）_quartz和task-CSDN博客](https://blog.csdn.net/weixin_51351637/article/details/125493351)
...
![image-20231107104907449](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107104907449.png)

![image-20231107104849446](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107104849446.png)

![image-20231107105332263](https://picture-typora-zhangjingqi.oss-cn-beijing.aliyuncs.com/image-20231107105332263.png)
